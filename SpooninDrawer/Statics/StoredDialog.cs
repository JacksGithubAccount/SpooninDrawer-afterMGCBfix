...
namespace SpooninDrawer.Statics
{
    static class StoredDialog
    {
        ...
        public static List<string> MinigameStrings = new List<string>{"Put the spoon in the drawer", "No, not like that", "You gotta spin it twistways", "Open the drawer first", "Why", "Did you just phase the drawer through your hand"}; 
