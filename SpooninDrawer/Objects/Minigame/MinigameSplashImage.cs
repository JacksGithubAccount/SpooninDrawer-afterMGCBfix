...
{
    public class MinigameSplashImage : BaseGameObject
    {
        ...
        public MinigameSplashImage(int DrawerImageNumber, Resolution resolution)
        {
        ...
        public MinigameSplashImage(string path)
        {
            Position = new Vector2(0, 0);
            TexturePath = path;
        }
